...
#### 2. hvv-monitor
Terminal-based HVV departure board and route planner. It features real-time data, transit-specific color coding, and modes for interactive searching, fixed-position monitoring, and journey planning.
